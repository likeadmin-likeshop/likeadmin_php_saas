...
use app\tenantapi\lists\setting\dict\DictDataLists;
use app\tenantapi\logic\setting\dict\DictDataLogic;
use app\tenantapi\validate\dict\DictDataValidate;


/**
 * 字典数据
 * Class DictDataController
 * @package app\tenantapi\controller\dictionary
 */
